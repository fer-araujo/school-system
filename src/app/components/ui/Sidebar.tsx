  ...
  return (
    <>
      ...
      <button
        ...
        className="lg:hidden fixed top-4 left-4 z-50 p-2.5 bg-slate-900 text-white rounded-xl border border-slate-700 shadow-lg"
      >
        {isMobileOpen ? <X size={20} /> : <Menu size={20} />}
      </button>

      <aside
        className={`bg-slate-950 border-r border-slate-800 flex flex-col fixed lg:sticky top-0 h-screen shrink-0 transition-all duration-300 ease-in-out z-40 ${
      ...
      >
        ...
        <div
          className={`border-b border-slate-800/60 z-10 transition-all duration-300 flex flex-col ${
        ...
        >
          ...
          >
            ...
            <button
              ...
              className={`text-slate-400 cursor-pointer hover:text-white hover:bg-slate-800 rounded-lg transition-all flex items-center justify-center shrink-0 ${
                isCollapsed
                  ? "w-10 h-10 bg-slate-800/40 border border-slate-700/50 shadow-sm"
                  : "p-1.5"
              }`}
            >
              {isCollapsed ? (
          ...
          <div
            className={`bg-slate-900/50 rounded-xl border border-slate-800 flex items-center transition-all duration-300 ${
              isCollapsed
                ? "p-1.5 justify-center w-11 h-11"
                : "p-3 gap-3 w-full"
            }`}
          >
        ...
        <nav
          ...
          className={`flex-1 space-y-1.5 overflow-y-auto overflow-x-hidden z-10 transition-all duration-300 ${
            isCollapsed ? "p-3" : "p-4"
          }`}
        >
        ...
        <div
          className={`p-4 z-10 border-t border-slate-800/60 transition-all duration-300 ${
